...
export function PrimaryCTA() {
  return (
    <section className="py-20 lg:py-28 bg-slate-950 text-white relative overflow-hidden border-t border-b border-slate-800">
      {/* Ambient Glow */}
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold font-manrope tracking-tight text-white leading-tight">
            Ready to Understand Your <span className="gradient-accent-teal">Credit Profile?</span>
          </h2>

          <p className="text-base sm:text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed font-inter">
            Start with a free assessment and take the first step toward a clearer financial plan with AAA CREDIT REPAIRS.
          </p>
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              ...
              <span>Speak to an Advisor: 9346437039</span>
            </a>
          </div>
        </motion.div>
      </div>
